...
const std::unordered_map<std::string, OptionTypeInfo>
    CloudFileSystemOptions::cloud_fs_option_type_info = {
        ...
        {"use_aws_transfer_manager",
         {offset_of(&CloudFileSystemOptions::use_aws_transfer_manager),
          OptionType::kBoolean}},
        {"cookie_on_open",
        ...
        {"new_cookie_on_open",
         {offset_of(&CloudFileSystemOptions::new_cookie_on_open),
          OptionType::kString}},
        {"force_cookie_on_open",
         {offset_of(&CloudFileSystemOptions::force_cookie_on_open),
          OptionType::kBoolean}},
        ...
        {"run_purger",
         {offset_of(&CloudFileSystemOptions::run_purger),
          OptionType::kBoolean}},
        {"delete_cloud_invisible_files_on_open",
         {offset_of(&CloudFileSystemOptions::delete_cloud_invisible_files_on_open),
          OptionType::kBoolean}},
